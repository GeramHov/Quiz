...
--
-- Host: mysql
-- Generation Time: Feb 16, 2023 at 03:44 PM
...
(1, 'PHP', 'Quel opérateur est utilisé pour vérifier si deux valeurs sont égales et sont du même type ?', '===', '==', '===', '!=', '=', NULL),
...
(3, 'JavaScript', 'Dans quel élement HTML peut-on ajouter du JavaScript?', '<xmp><script></xmp>', '<xmp><scripting></xmp>', '<xmp><js></xmp>', '<xmp><script></xmp>', '<xmp><javascript></xmp>', NULL),
...
(5, 'JavaScript', 'Quel est l\'endroit correct pour ajouter du JavaScript ?', 'La section <xmp><head></xmp> et la section <xmp><body></xmp>', 'La section <xmp><head></xmp> et la section <xmp><body></xmp>', 'La section <xmp><head></xmp>', 'La section <xmp><body></xmp>', 'La section <xmp><footer></xmp>', NULL),
(6, 'JavaScript', 'Quel est la syntaxe correcte pour appeler un script externe nommé \"xxx.js\" ?', '<xmp><script src=\"xxx.js\"></xmp>', '<xmp><script src=\"xxx\"></xmp>', '<xmp><script href=\"xxx.js\"></xmp>', '<xmp><script name=\"xxx.js\"></xmp>', '<xmp><script src=\"xxx.js\"></xmp>', NULL),
...
(8, 'JavaScript', 'Comment créer une fonction dans JavaScript ?', 'function myFunction() ', '()=> function', 'function = myFunction()', 'function:myFunction()', 'function myFunction()  ', NULL),
(9, 'JavaScript', 'Comment écrire une condition IF dans JavaScript ?', 'if (i == 5) ', 'if i = 5', 'if (i == 5) ', 'if i == 5 then', 'if i = 5 then', NULL),
(10, 'JavaScript', 'Comment écrire une condition IF quand le \"i\" n\'est pas égale à 5 ?', 'if (i != 5) ', 'if (i != 5) ', 'if i <> 5', 'if (i <> 5)', 'if i =! 5 then', NULL),
...
(26, 'HTML-CSS', 'Comment appeler un fichier .css externe correctement dans HTML ?', '<xmp><link rel=\"stylesheet\" type=\"text/css\" href=\"mystyle.css\"></xmp>', '<xmp><style src=\"mystyle.css\"></xmp>', '<xmp><link rel=\"stylesheet\" type=\"text/css\" href=\"mystyle.css\"></xmp> ', '<xmp><stylesheet>mystyle.css</stylesheet></xmp>', '<xmp><link href=\"stylesheet\" type=\"text/css\" href=\"mystyle.css\"></xmp>', NULL),
...
(28, 'HTML-CSS', 'Quel propriété CSS utilise-t-on pour changer la couler d\'un texte ?', 'color', 'text-color', 'fgcolor', 'font-color', 'color', NULL),
(29, 'HTML-CSS', 'Quel est la bonne syntaxe pour ouvrir le lien dans une nouvelle page ?', '<xmp><a href=\"url\" target=\"_blank\"></xmp>', '<xmp><a href=\"url\" new></xmp>', '<xmp><a href=\"url\" target=\"new\"></xmp>', '<xmp><a href=\"url\" target=\"_blank\"></xmp>', '<xmp><a href=\"url\" target=\"new page\"></xmp>', NULL),
(30, 'HTML-CSS', 'Quelle est la propriété CSS qui change le taille d\'un texte ?', 'font-size', 'text-style', 'font-size', 'font-style', 'text-size', NULL),
...
(35, 'HTML-CSS', 'Quelle est la syntaxe correcte pour intégrer une image dans un document HTML ?', '<xmp><img src=\"image.gif\" alt=\"MyImage\"></xmp>', '<xmp><img src=\"image.gif\" alt=\"MyImage\"></xmp>', '<xmp><image src=\"image.gif\" alt=\"MyImage\"></xmp>', '<xmp><img href=\"image.gif\" alt=\"MyImage\"></xmp>', '<xmp><img alt=\"MyImage\">image.gif</img></xmp>', NULL),
...
(46, 'PHP', 'Comment terminer correctement un status en PHP?', ';', '.', ';', ',', '<xml></php></xml>', NULL),
...
(48, 'PHP', 'Quel est le moyen correct pour inclure le fichier \"time.inc\" en PHP?', '<xmp><?php include \"time.inc\"; ?></xmp>', '<xmp><?php include:\"time.inc\"; ?></xmp>', '<xmp><!-- include file=\"time.inc\" --></xmp>', '<xmp><?php include file=\"time.inc\"; ?></xmp>', '<xmp><?php include \"time.inc\"; ?></xmp>', NULL),
...
(53, 'PHP', 'Comment ajouter un commentaire dans PHP ?', '\'/*...*/\'', '\'*\\...\\*\'', '\'<!--...-->\'', '\'/*...*/\'', '<xmp><comment>...</comment></xmp>', NULL),
